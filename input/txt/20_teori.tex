...
Det är från data series för $x(t)$ som ni genom kurvanpassning, med
...
tidsberoende. Vi kan välja att beskriva denna med olika grad av
förenklingar.
\begin{description}
...
uttryck för utvecklingen av \ce{SCN-}:
