...
\usepackage{authblk}
\usepackage[style=chem-acs,doi,autocite=superscript,pageranges=false]{biblatex}
...
\newcommand*{\plimsoll}{{\ensuremath{-\kern-4pt{\ominus}\kern-4pt-}}} % standard state symbol
